                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-warning text-dark">
                            <h6 class="m-0 font-weight-bold">
                                Ubah Akun Biaya: <strong><?= $akun->kode_perkiraan ?> - <?= $akun->nama ?></strong>
                            </h6>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('akunbiaya/proses_ubah/' . $akun->id) ?>" method="POST">
                                <div class="row">
                                    <!-- KIRI -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tipe_akun" id="tipe_akun" class="form-control"
                                                value="<?= set_value('tipe_akun', $akun->tipe_akun) ?>"
                                                list="tipe_akun_list" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode_perkiraan" id="kode_perkiraan"
                                                class="form-control"
                                                value="<?= set_value('kode_perkiraan', $akun->kode_perkiraan) ?>"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control"
                                                value="<?= set_value('nama', $akun->nama) ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="akun_induk" id="akun_induk" class="form-control"
                                                ...
                                                value="<?= set_value('akun_induk', $akun->akun_induk) ?>"
                                                list="akun_induk_list">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="saldo_awal" id="saldo_awal" class="form-control"
                                                placeholder="0"
                                                value="<?= set_value('saldo_awal', number_format($akun->saldo_awal ?? 0, 0, ',', '.')) ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_kas_bank" class="form-control">
                                                <option value="0" <?= set_select('is_kas_bank', '0', ($akun->is_kas_bank ?? 0) == 0) ?>>Tidak</option>
                                                <option value="1" <?= set_select('is_kas_bank', '1', ($akun->is_kas_bank ?? 0) == 1) ?>>Ya</option>
                                            </select>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-warning btn-lg">
                                        <i class="fa fa-save"></i> Update Akun
                                    </button>
                                </div>
                            </form>
                        </div>
