                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Rute</h6>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('rute/proses_tambah') ?>" method="post">
                                <div class="row">
                                    <!-- KIRI -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong>Customer</strong> <span class="text-danger">*</span></label>
                                            <input type="text" name="customer" class="form-control" placeholder="Contoh: AJS, Shopee" required>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="origin" class="form-control" placeholder="Contoh: Sunter DC" required>
                                        </div>

                                        <div class="form-group">
                                            <label><strong>Destination 1</strong> <span class="text-danger">*</span></label>
                                            <input type="text" name="dest1" class="form-control" placeholder="Contoh: Surabaya DC" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Destination 2 <small class="text-muted">(Opsional)</small></label>
                                            <input type="text" name="dest2" class="form-control" placeholder="Kosongkan jika tidak ada">
                                        </div>

                                        <div class="form-group">
                                            <label>Destination 3 <small class="text-muted">(Opsional)</small></label>
                                            <input type="text" name="dest3" class="form-control" placeholder="Kosongkan jika tidak ada">
                                        </div>

                                        <div class="form-group">
                                            <label>Destination 4 <small class="text-muted">(Opsional)</small></label>
                                            <input type="text" name="dest4" class="form-control" placeholder="Kosongkan jika tidak ada">
                                        </div>

                                        <div class="form-group">
                                            <label><strong>Harga</strong> <span class="text-danger">*</span></label>
                                            <input type="text" name="harga" class="form-control text-right" placeholder="Contoh: 2500000" required>
