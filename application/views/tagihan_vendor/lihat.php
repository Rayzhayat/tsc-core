...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <a href="<?= base_url('tagihan_vendor/tambah') ?>" class="btn btn-primary btn-sm shadow-sm">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="get" action="<?= base_url('tagihan_vendor') ?>" id="filterForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label class="small font-weight-bold">Cari Invoice/Vendor</label>
                                        <input type="text" name="keyword" class="form-control" 
                                               placeholder="No Invoice atau Nama Vendor"
                                        ...
                                        <?php if (empty($tagihan)): ?>
                                            <tr>
                                                <td colspan="8" class="text-center text-muted">
                                                    ...
                                                    <p>Tidak ada data tagihan vendor</p>
                                                </td>
                                            </tr>
                                        <?php else: ?>
                                            <?php 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <?php if (!empty($item->kode_payment)): ?>
                                                            <small class="text-muted"><?= htmlspecialchars($item->kode_payment) ?></small>
                                                        <?php else: ?>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('tagihan_vendor/detail/' . $item->id) ?>" 
                                                           class="btn btn-info btn-sm" title="Detail">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <?php if ($item->status_payment != 'Paid'): ?>
                                                            <a href="<?= base_url('tagihan_vendor/ubah/' . $item->id) ?>" 
                                                               class="btn btn-warning btn-sm" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        <?php endif ?>
                                                        <a href="<?= base_url('tagihan_vendor/hapus/' . $item->id) ?>" 
    ...
    <script>
        function exportExcel() {
            ...
            window.location.href = '<?= base_url('tagihan_vendor/export_excel') ?>?' + params.toString();
        }
        
        function exportPDF() {
            const params = new URLSearchParams(window.location.search);
            window.open('<?= base_url('tagihan_vendor/export_pdf') ?>?' + params.toString(), '_blank');
        }
    </script>
</body>
</html>