                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 no-print">
                        <h1 class="h3 mb-0 text-gray-800">
                            <i class="fas fa-file-invoice text-danger"></i> <?= $title ?>
                        </h1>
                        <div>
                            ...
                            <?php if ($tagihan->status_payment != 'Paid'): ?>
                                <a href="<?= base_url('tagihan_vendor/ubah/' . $tagihan->id) ?>" class="btn btn-warning btn-sm shadow-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                            <?php endif ?>
                            <a href="<?= base_url('tagihan_vendor') ?>" class="btn btn-primary btn-sm shadow-sm">
                    ...
                    <div class="print-section text-center mb-4">
                        <h2 class="font-weight-bold">DETAIL TAGIHAN VENDOR</h2>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-hashtag text-danger"></i> No Invoice
                                                </div>
                                                <div class="info-value">
                                                    <strong><?= htmlspecialchars($tagihan->no_invoice) ?></strong>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-calendar text-danger"></i> Invoice Date
                                                </div>
                                                <div class="info-value">
                                                    <?= !empty($tagihan->invoice_date) ? date('d F Y', strtotime($tagihan->invoice_date)) : '-' ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-building text-danger"></i> Vendor
                                                </div>
                                                <div class="info-value">
                                                    <?= htmlspecialchars($tagihan->nama_vendor) ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-calendar-check text-danger"></i> Invoice Receive Date
                                                </div>
                                                <div class="info-value">
                                                    <?= !empty($tagihan->invoice_recieve_date) ? date('d F Y', strtotime($tagihan->invoice_recieve_date)) : '-' ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-ship text-danger"></i> Bulan Shipment
                                                </div>
                                                <div class="info-value">
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <div class="info-label">
                                                    <i class="fas fa-barcode text-danger"></i> Kode Payment
                                                </div>
                                                <div class="info-value">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="info-row bg-light" style="padding: 20px; border-radius: 8px;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h5 class="mb-0 text-danger">Nominal Tagihan</h5>
                                                ...
                                                <div class="payment-item">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            ...
                                                            <?php endif ?>
                                                            <?php if (!empty($pay->reff_no)): ?>
                                                                <p class="mb-0 text-muted small">
                                                                    <i class="fas fa-hashtag"></i> Reff: <?= htmlspecialchars($pay->reff_no) ?>
                                                                </p>
                                                            <?php endif ?>
                                                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if (!empty($payments)): 
                                        ...
                                        $sisa_tagihan = $tagihan->nominal - $total_terbayar;
                                    ?>
                                        <div class="info-row">
                                    ...
                                    <div class="info-row">
                                        <div class="info-label small">Vendor ID</div>
                                        <div class="info-value">
                                            <code><?= htmlspecialchars($tagihan->tagihan_vendor) ?></code>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow no-print">
                                ...
                                <div class="card-body">
                                    <?php if ($tagihan->status_payment != 'Paid'): ?>
                                        <a href="<?= base_url('pengeluaran/vendor/' . $tagihan->id) ?>" class="btn btn-success btn-block mb-2">
                                            <i class="fas fa-money-bill-wave"></i> Bayar Tagihan
                                        </a>
                                        <a href="<?= base_url('tagihan_vendor/ubah/' . $tagihan->id) ?>" class="btn btn-warning btn-block mb-2">
                                    ...
                                    <a href="<?= base_url('tagihan_vendor') ?>" class="btn btn-primary btn-block">
                                        <i class="fas fa-arrow-left"></i> Kembali
                                    </a>
                                </div>
                            </div>
