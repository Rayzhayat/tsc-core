                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <?php if ($can_edit): ?>
                            <div class="d-flex gap-2">
                                <a href="<?= base_url('customer/export') ?>" class="btn btn-danger btn-sm">
                                    <i class="fa fa-file-pdf me-1"></i>Export PDF
                                </a>
                                <a href="<?= base_url('customer/tambah') ?>" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus me-1"></i>Tambah Customer
                                </a>
                            </div>
                        <?php endif ?>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                <div class="d-flex align-items-center gap-2">
                                    <h6 class="mb-0 fw-semibold text-primary">Daftar Customer</h6>
                                    <span class="badge bg-primary badge-customer-count">
                                        <?= number_format(count($all_customer ?? []), 0, ',', '.') ?> Customer
                                    </span>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <form id="searchForm" class="input-group input-group-sm">
                                        <input type="text" id="searchInput" class="form-control"
                                            placeholder="Cari kode, nama, NPWP..." autocomplete="off">
                                ...
                                <table class="table table-bordered table-hover table-sm mb-0" id="dataTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="9%">PIC</th>
                                            <th width="9%">NPWP</th>
                                            <th width="11%">Nama NPWP</th>
                                            <th width="5%">PPH</th>
                                            <th width="5%">PPN</th>
                                            <th width="13%">Alamat</th>
                                            <th width="<?= $can_edit ? '12%' : '8%' ?>">Aksi</th>
                                        </tr>
                                    </thead>
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadData() {
                ...
                $.post('<?= base_url('customer/filter') ?>', { keyword, ppn, pph, limit, offset }, function (response) {
                    ...
                    $('.badge-customer-count').text(totalRecords.toLocaleString('id-ID') + ' Customer');
