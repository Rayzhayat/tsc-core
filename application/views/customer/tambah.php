				...
				<div class="container-xl">
					...
					<div class="card shadow">
						<div class="card-header">
							<strong>Form Tambah Customer</strong>
						</div>
						<div class="card-body">
							<form action="<?= base_url('customer/proses_tambah') ?>" method="POST" id="form-tambah">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Kode Customer <span class="text-danger">*</span></label>
											<input type="text" name="kode" class="form-control"
												value="<?= $kode_customer ?>" readonly>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<select name="ppn" class="form-control">
												...
												<?php foreach ($ppn_options as $opt): ?>
													<option value="<?= $opt ?>" <?= $opt == '11%' ? 'selected' : '' ?>>
														<?= $opt ?></option>
												<?php endforeach; ?>
											</select>
